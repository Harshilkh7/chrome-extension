      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        {loading ? (
          ...
          <p className="text-gray-600 text-lg text-center mt-20">
            No consents logged yet. Browse a site with the extension installed and it will show up
            here.
          </p>
        ) : (
            ...
            {consents.map((consent) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-xl font-semibold text-indigo-700 truncate">{consent.service}</h3>
                  <ExternalLink
